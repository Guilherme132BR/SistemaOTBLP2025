...
public class JDlgClientePesquisa extends javax.swing.JDialog {
    ...
    public JDlgClientePesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Tabela de Clientes Cadastrados");
        setLocationRelativeTo(null);
        clienteControllerOtb = new ClienteControllerOtb();
        ClienteOtb_DAO cliente_DAO = new ClienteOtb_DAO();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        ClienteOtb clienteOtb = clienteControllerOtb.getBean(rowSel);
        jDlgCliente.beanView(clienteOtb);
        setVisible(false);
