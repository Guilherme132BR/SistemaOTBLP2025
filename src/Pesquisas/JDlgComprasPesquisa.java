...
public class JDlgComprasPesquisa extends javax.swing.JDialog {
    ...
    private ComprasControllerOtb ComprasControllerOtb;
    
    /**
     * Creates new form JDlgComprasPesquisa
     */
    public JDlgComprasPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Tabela de Compras cadastradas");
        ComprasControllerOtb = new ComprasControllerOtb();
        ComprasOtb_DAO comprasOtb_DAO = new ComprasOtb_DAO();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        ComprasOtb comprasOtb = ComprasControllerOtb.getBean(rowSel);
        jDlgCompras.beanView(comprasOtb);
        setVisible(false);
